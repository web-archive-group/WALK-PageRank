...
# clean up
jq -c -n --slurpfile nodes <(cat /data/derivatives/pagerank/$1-nodes/part-*) --slurpfile links \
  <(cat /data/derivatives/pagerank/$1-links/part-*) '{nodes: $nodes, links: $links}' > $1-graph.json